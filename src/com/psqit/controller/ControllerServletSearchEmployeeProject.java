...
// creating a class ControllerServletSearchEmployeeProject which is extending
// HttpServlet
public class ControllerServletSearchEmployeeProject extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// calling the searchEmployeeProject Method Of Dao Layer and getting the
			// returning list into employeeprojectlist
