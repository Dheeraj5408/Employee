...
public class Empdao {
	...
	public String addEmployee() {
		...
		//	String query1="insert into employees(name) VALUES(?)";
	        ...
	        //System.out.println("get value from pojo "+ epojo.getEmp_id() + " "+ epojo.getEmp_name() );
	...
	public List<Emspojo> searchEmployee(Emspojo p){  
	    ...
	    try{  
	    	Class.forName("com.mysql.cj.jdbc.Driver");
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employees","root","root");
	    	String q1 = "select employees.id , employees.name , salary.salary from employees INNER JOIN salary ON employees.id = salary.id WHERE employees.id=" +p.getEmp_id();
